...
<html lang="en-US">
    ...
    <body>
        <div class="parentspeak">
            <img style="width: 100%;" src="/images/pltitle.png"  alt="家长有话说" >
            <img style="width: 100%;" src="/images/parent1.png"  alt="家长有话说" >
              <a class="video" rel="video" href="javascript:;"> 
                      <img style="width: 100%" class="video-img1" src="/images/parent3.png"  alt="家长有话说">
...
<!--                    <img style="width: 100%"  src="/images/parent3.png"  alt="家长有话说">-->
            ...
            <img style="width: 100%;" src="/images/parent4.png"  alt="家长有话说" >
            <img style="width: 100%;" src="/images/parent5.png"  alt="家长有话说" >
            <img style="width: 100%;" src="/images/parent6.png"  alt="家长有话说" >
            <img style="width: 100%;" src="/images/parent7.png"  alt="家长有话说" >
            <img style="width: 100%;" src="/images/parent8.png"  alt="家长有话说" >
            <img style="width: 100%;" src="/images/parent9.png"  alt="家长有话说" >
            <?php if (!empty($qrcode["qrcode"])) : ?>
                <img style="width: 100%" src="<?= $qrcode["qrcode"] ?>"  alt="家长有话说">
            <?php endif; ?>
        </div>
    <body>
</html>
...
<?= json_encode($wechat->jsApiConfig()) ?>
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareTimeline({
            ...
            link: add + 'introduce/parent-speak',
